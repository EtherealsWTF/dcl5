...
const transform13 = new Transform({
  position: new Vector3(12, 22.507265090942383, 31),
...
const transform14 = new Transform({
  position: new Vector3(7.859310150146484, 22.50726318359375, 30.604869842529297),
  rotation: new Quaternion(4.650567057780429e-15, -1, 1.1920927533992653e-7, 0),
...
const transform15 = new Transform({
  position: new Vector3(3.9310388565063477, 22.50726318359375, 30.5),
  rotation: new Quaternion(4.650567057780429e-15, -1, 1.1920927533992653e-7, 0),
  scale: new Vector3(4.408076763153076, 4.408059597015381, 0.5292626619338989)
})
...
logoOnTheBuilding.addComponentOrReplace(transform21)
const gltfShape2 = new GLTFShape("44a4a91e-5e41-43e1-b6d0-c14cc4c14c97/logo on the building.glb")
gltfShape2.withCollisions = true
gltfShape2.isPointerBlocker = true
gltfShape2.visible = true
logoOnTheBuilding.addComponentOrReplace(gltfShape2)
...
building.addComponentOrReplace(transform22)
const gltfShape3 = new GLTFShape("da0fd735-9d22-4954-81fd-cb14cf2b9dde/building.glb")
gltfShape3.withCollisions = true
gltfShape3.isPointerBlocker = true
gltfShape3.visible = true
building.addComponentOrReplace(gltfShape3)
...
soundSystem.addComponentOrReplace(transform23)
const gltfShape4 = new GLTFShape("e6f24cb1-cedc-4e0c-bdb2-aa7dddb25e8a/sound system.glb")
gltfShape4.withCollisions = true
gltfShape4.isPointerBlocker = true
gltfShape4.visible = true
soundSystem.addComponentOrReplace(gltfShape4)
...
galleryLights3.addComponentOrReplace(transform24)
const gltfShape5 = new GLTFShape("bac5ac97-5779-4978-b369-e8cf755a143f/gallery lights2.glb")
gltfShape5.withCollisions = true
gltfShape5.isPointerBlocker = true
gltfShape5.visible = true
galleryLights3.addComponentOrReplace(gltfShape5)
...
nftPictureFrame7.addComponentOrReplace(transform26)
...
nftPictureFrame17.addComponentOrReplace(transform27)
...
nftPictureFrame18.addComponentOrReplace(transform28)
...
nftPictureFrame19.addComponentOrReplace(transform29)
...
nftPictureFrame20.addComponentOrReplace(transform30)
...
nftPictureFrame21.addComponentOrReplace(transform31)
...
nftPictureFrame22.addComponentOrReplace(transform32)
...
nftPictureFrame23.addComponentOrReplace(transform33)
...
elevator.addComponentOrReplace(transform34)
const gltfShape6 = new GLTFShape("9e7a7c36-d10f-46a0-8dee-2d8f53466042/elevator2.glb")
gltfShape6.withCollisions = true
gltfShape6.isPointerBlocker = true
gltfShape6.visible = true
elevator.addComponentOrReplace(gltfShape6)
...
elevator2.addComponentOrReplace(transform35)
const gltfShape7 = new GLTFShape("b9d9bd34-fdf6-489f-adeb-ad94fd665f7e/elevator1.glb")
gltfShape7.withCollisions = true
gltfShape7.isPointerBlocker = true
gltfShape7.visible = true
elevator2.addComponentOrReplace(gltfShape7)
...
djdisc.addComponentOrReplace(transform36)
const gltfShape8 = new GLTFShape("d7072463-a420-41e4-9fd5-65c554dccd53/djdisc1.glb")
gltfShape8.withCollisions = true
gltfShape8.isPointerBlocker = true
gltfShape8.visible = true
djdisc.addComponentOrReplace(gltfShape8)
...
djdisc2.addComponentOrReplace(transform37)
const gltfShape9 = new GLTFShape("e47914bf-6ca9-4845-8061-ce6ca043e110/djdisc2.glb")
gltfShape9.withCollisions = true
gltfShape9.isPointerBlocker = true
gltfShape9.visible = true
djdisc2.addComponentOrReplace(gltfShape9)
...
djset.addComponentOrReplace(transform38)
const gltfShape10 = new GLTFShape("fbc617fa-0eec-42ce-8be3-6244873f8115/djset.glb")
gltfShape10.withCollisions = true
gltfShape10.isPointerBlocker = true
gltfShape10.visible = true
djset.addComponentOrReplace(gltfShape10)
...
discoball.addComponentOrReplace(transform39)
const gltfShape11 = new GLTFShape("885a99c6-3460-4744-9815-70277e355ef4/discoball.glb")
gltfShape11.withCollisions = true
gltfShape11.isPointerBlocker = true
gltfShape11.visible = true
discoball.addComponentOrReplace(gltfShape11)
...
barchairs.addComponentOrReplace(transform40)
const gltfShape12 = new GLTFShape("b94ae756-8f56-43f7-8729-dac0e8fe3a3e/barchairs.glb")
gltfShape12.withCollisions = true
gltfShape12.isPointerBlocker = true
gltfShape12.visible = true
barchairs.addComponentOrReplace(gltfShape12)
...
bar.addComponentOrReplace(transform41)
const gltfShape13 = new GLTFShape("8c438e7b-f207-4f9a-8163-d4fb8623ac15/bar.glb")
gltfShape13.withCollisions = true
gltfShape13.isPointerBlocker = true
gltfShape13.visible = true
bar.addComponentOrReplace(gltfShape13)
...
decorationLatest.addComponentOrReplace(transform42)
const gltfShape14 = new GLTFShape("9a5b069a-f8e8-46a0-9ed3-df3dc4ca5594/decoration latest.glb")
gltfShape14.withCollisions = true
gltfShape14.isPointerBlocker = true
gltfShape14.visible = true
decorationLatest.addComponentOrReplace(gltfShape14)
...
fridge.addComponentOrReplace(transform43)
const gltfShape15 = new GLTFShape("eeb0413d-6813-4d98-9cca-7f75694b3268/fridge.glb")
gltfShape15.withCollisions = true
gltfShape15.isPointerBlocker = true
gltfShape15.visible = true
fridge.addComponentOrReplace(gltfShape15)
...
drinks.addComponentOrReplace(transform44)
const gltfShape16 = new GLTFShape("9e34db82-91de-4dfd-9575-296ba7dbb1af/drinks.glb")
gltfShape16.withCollisions = true
gltfShape16.isPointerBlocker = true
gltfShape16.visible = true
drinks.addComponentOrReplace(gltfShape16)
...
arrow.addComponentOrReplace(transform45)
const gltfShape17 = new GLTFShape("156dd4bb-9d13-4036-ba15-fbe347406529/arrow.glb")
gltfShape17.withCollisions = true
gltfShape17.isPointerBlocker = true
gltfShape17.visible = true
arrow.addComponentOrReplace(gltfShape17)
...
greenLasersBeams.addComponentOrReplace(transform46)
const gltfShape18 = new GLTFShape("3e7a0357-3e50-4318-ad92-e61a990be86e/2 green lasers beams.glb")
gltfShape18.withCollisions = true
gltfShape18.isPointerBlocker = true
gltfShape18.visible = true
greenLasersBeams.addComponentOrReplace(gltfShape18)
...
oneGreenLaserBeam.addComponentOrReplace(transform47)
const gltfShape19 = new GLTFShape("7351d312-2baa-450f-8ec5-64869a77146d/one green laser beam.glb")
gltfShape19.withCollisions = true
gltfShape19.isPointerBlocker = true
gltfShape19.visible = true
oneGreenLaserBeam.addComponentOrReplace(gltfShape19)
...
greenLasers.addComponentOrReplace(transform48)
const gltfShape20 = new GLTFShape("97814e65-1c0c-4297-bbfd-fddf0bded1c3/2 green lasers.glb")
gltfShape20.withCollisions = true
gltfShape20.isPointerBlocker = true
gltfShape20.visible = true
greenLasers.addComponentOrReplace(gltfShape20)
...
greenlaserHolder.addComponentOrReplace(transform49)
const gltfShape21 = new GLTFShape("8991cecd-1561-4ebc-99c4-7818e13e248c/greenlaser holder.glb")
gltfShape21.withCollisions = true
gltfShape21.isPointerBlocker = true
gltfShape21.visible = true
greenlaserHolder.addComponentOrReplace(gltfShape21)
...
oneGreenLaser.addComponentOrReplace(transform50)
const gltfShape22 = new GLTFShape("e3f51269-59d0-4656-ad45-d83e7b0ec36d/one green laser.glb")
gltfShape22.withCollisions = true
gltfShape22.isPointerBlocker = true
gltfShape22.visible = true
oneGreenLaser.addComponentOrReplace(gltfShape22)
...
videoStream.addComponentOrReplace(transform51)
...
ghostForEthereals.addComponentOrReplace(transform52)
const gltfShape23 = new GLTFShape("4e90aec9-0f54-4d18-a04d-730d5953d16d/ghost for ethereals .glb")
gltfShape23.withCollisions = true
gltfShape23.isPointerBlocker = true
gltfShape23.visible = true
ghostForEthereals.addComponentOrReplace(gltfShape23)
...
arcade.addComponentOrReplace(transform53)
const gltfShape24 = new GLTFShape("f219405d-8b12-4872-98e9-9f7e0e6a1161/arcade.glb")
gltfShape24.withCollisions = true
gltfShape24.isPointerBlocker = true
gltfShape24.visible = true
arcade.addComponentOrReplace(gltfShape24)
...
script4.spawn(videoStream, {"startOn":"false","onClickText":"Play video","volume":1,"onClick":[],"onActivate":[{"entityName":"videoStream","actionId":"activate","values":{}}]}, createChannel(channelId, videoStream, channelBus))